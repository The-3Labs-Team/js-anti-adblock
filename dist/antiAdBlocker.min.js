import{detectAdBlock}from"/resources/detectAdBlock.js";export default class AntiAdBlocker{constructor({color:e,logo:{url:t,width:n,heigth:o},hiddenBody:i}){const l={color:e,logo:{url:t??"./assets/logo.svg",width:n??"300px",height:o??"50px"},hiddenBody:i??!0},a=document.querySelector("body");function s(){return`<div id="content-1" style="display: flex; padding: 30px 10px 10px; min-height: 305px;">
          ...
          </div> `}window.onload=async()=>{var e;await detectAdBlock()&&(a.setAttribute("aria-hidden","true"),l.hiddenBody&&(a.innerHTML=""),a.style.overflow="hidden",a.innerHTML+=`
