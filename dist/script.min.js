const config={color:"#db2027",logo:{url:"https://www.tomshw.it/wp-content/uploads/2021/09/toms_logo_nero.svg",width:"300px",height:"50px"},hiddenBody:!0},body=document.querySelector("body");async function detectAdBlock(){let t=!1;try{const e=["uBlock","height:1px!important"];await fetch(new Request("https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js")).then(e=>(e.headers.get("content-length")||(t=!0),e)).then(e=>e.text()).then(o=>{e.some(e=>o.includes(e))&&(t=!0)}).catch(e=>t=!0)}catch(e){t=!0}finally{console.log("AdBlock Enabled: "+t)}t&&(body.setAttribute("aria-hidden","true"),config.hiddenBody&&(body.innerHTML=""),showBannerAdBlock())}function showBannerAdBlock(){body.style.overflow="hidden",body.innerHTML+=`
...
`}function getRandomStyle(){const o=[{name:"width",value:"100%"},{name:"height",value:"100vh"},{name:"padding",value:"10px"},{name:"background-color",value:"rgba(0,0,0,0.68)"},{name:"position",value:"fixed"},{name:"top",value:"0"},{name:"left",value:"0"},{name:"z-index",value:"999999"},{name:"display",value:"flex"},{name:"font-family",value:"Arial Nova"},{name:"backdrop-filter",value:"blur(5px)"}];return Array.from({length:o.length},(e,o)=>o).sort(()=>Math.random()-.5).map(e=>`${o[e].name}: ${o[e].value};`).join(" ")}window.onload=detectAdBlock();